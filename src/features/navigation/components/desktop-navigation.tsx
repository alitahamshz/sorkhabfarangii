      ...
      >
        {categories.map((category, index) => (
          <li className="group flex h-full items-center" key={category.id}>
            <button
              className={`flex items-center gap-1 whitespace-nowrap transition-colors hover:text-secondary-500 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary-500 group-hover:text-secondary-500 ${
